    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_SearchPortal2.default, null)
            );
        }
    }]);
...
var SearchPortal = function (_React$Component) {
    ...
    _createClass(SearchPortal, [{
        ...
        value: function componentDidMount() {
            ...
            this.fuse = new _fuse2.default(scriptureData, options);
        }
    }, {
        key: 'onSearchUpdate',
        ...
        key: 'getResults',
        value: function getResults(searchValue) {
        ...
        value: function goToClickedResult(result) {
            var libraryLink = this.buildLibraryLink(result);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_SearchBar2.default, { searchValue: searchValue, onSearchUpdate: this.onSearchUpdate }),
                _react2.default.createElement(_SearchResultsList2.default, { results: searchResults, goToClickedResult: this.goToClickedResult })
            );
        }
    }]);
    ...
    _createClass(SearchBar, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("input", { value: searchValue, onChange: this.update, type: "text" })
            );
        }
    }]);
...
var SearchResult = function (_React$Component) {
    ...
    function SearchResult(props) {
        ...
        _this.onResultClicked = _this.onResultClicked.bind(_this);
        return _this;
    }

    _createClass(SearchResult, [{
        key: 'onResultClicked',
        value: function onResultClicked() {
